...
<div class="wrap">
    <ul class="lot-award mt5">
      <li class="logo"> <img src="http://www.123456cp.com/style/images/pk10-logo.png" alt="北京赛车pk10" width="82" height="82"/> </li>
...
<?php
//php开奖视频引用
// echo "<a href='http://www.wj2017.com/Application/Fuzhi/View/shipin/new_pk10.html'>官方开奖视频</a>"
?>
		...
		-->
<iframe src="http://kj.kai861.com/view/video/PK10/video.html?10001?1682013.cn" width="100" scrolling="no" height="100%" frameborder="0" style="width: 1128px; height: 735.652px;"></iframe>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" border="0" class="gm_t1">
        <tr>
            <td>北京赛车(PK10) <span class="sy">今天输赢：</span><span id="user_sy" class="sy_n">0.00</span>
