...
<div class="wrap">
    <ul class="lot-award mt5">
      <li class="logo"> <img src="http://www.98007.com/views/cpkj/images/xync-logo.png" alt="" width="82" height="82"/> </li>
...
<?php
//php开奖视频引用
echo "<a href='http://www.qx666.com/style/xync/video.swf'>官方开奖视频</a>"
?>
    <p><img src="http://www.123456cp.com/style/images/loading2.gif" width="100" height="20" alt="载入中"><p> 
		-->
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" border="0" class="gm_t1">
        <tr>
            <td>重庆幸运农场 <span class="sy">今天输赢：</span><span id="user_sy" class="sy_n">0.00</span>
