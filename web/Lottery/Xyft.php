...
<div class="wrap">
    <ul class="lot-award mt5">
      <li class="logo"> <img src="http://www.123456cp.com/style/images/xyft-logo.png" alt="北京赛车xyft" width="82" height="82"/> </li>
      <li class="currentAward">
        
        <div class="period" style="color: green;"></div>
        <div class="lot-nums">
  <p><img src="http://www.123456cp.com/style/images/loading2.gif" width="100" height="20" alt="载入中"><p> 
        </div>		
<?php
//php开奖视频引用
echo "<a href='http://www.wj2017.com/Application/Fuzhi/View/shipin/new_xyft.html'>官方开奖视频</a>"
?>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" border="0" class="gm_t1">
        <tr>
            <td>幸运飞艇 <span class="sy">今天输赢：</span><span id="user_sy" class="sy_n">0.00</span>
