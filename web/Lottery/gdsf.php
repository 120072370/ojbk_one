...
<div class="wrap">
    <ul class="lot-award mt5">
      <li class="logo"> <img src="http://www.98007.com/views/cpkj/images/gdkl10-logo.png" alt="重庆时时彩" width="82" height="82"/> </li>
...
<?php
//php开奖视频引用
echo "<a href='http://www.98007.com/video/gdkl10/index.html'>官方开奖视频</a>"
?>
    <p><img src="http://www.123456cp.com/style/images/loading2.gif" width="100" height="20" alt="载入中"><p> 
        </div>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" border="0" class="gm_t1">
        <tr>
            <td>广东快乐十分 <span class="sy">今天输赢：</span><span id="user_sy" class="sy_n">0.00</span>
