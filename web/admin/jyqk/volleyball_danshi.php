  ...
  <table width="900" height="0" cellpadding="0" cellspacing="0">
	<tr style="width:150px;">
	  ...
	  <td width="119">类型：
		...
		<option value="volleyball_danshi.php?match_type=<?=$match_type?>" selected>排球</option>
        ...
        <td><table cellspacing="0" cellpadding="0" width="100%" border="0">
          <tbody>
            ...
            <tr align="right">
              ...
              <td><a href="look_ds.php?match_id=<?=$rows["Match_ID"]?>&point_column=Match_DxXpl" ><?=getString($arr[$rows["Match_ID"]]["match_dxxpl"]['num'])?>/<?=getString($arr[$rows["Match_ID"]]["match_dxxpl"]['money'])?></a> </td>
            </tr>
            <tr>
              <td colspan="3"> </td>
            </tr>
        ...
        <td><table cellspacing="0" cellpadding="0" width="100%" border="0">
          <tbody>
            <tr align="right">
              ...
              <td width="73%"><a href="look_ds.php?match_id=<?=$rows["Match_ID"]?>&point_column=Match_DsDpl" ><?=getString($arr[$rows["Match_ID"]]["match_dsdpl"]['num'])?>/<?=getString($arr[$rows["Match_ID"]]["match_dsdpl"]['money'])?></a> </td>
            </tr>
            <tr align="right">
              <td>  <font color="#0033FF">雙</font></td>
              <td><a href="look_ds.php?match_id=<?=$rows["Match_ID"]?>&point_column=Match_DsSpl"><?=getString($arr[$rows["Match_ID"]]["match_dsspl"]['num'])?>/<?=getString($arr[$rows["Match_ID"]]["match_dsspl"]['money'])?></a></td>
            </tr>
          </tbody>
        </table></td>
    </tr>
