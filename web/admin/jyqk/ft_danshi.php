      ...
      <div style="color:#009933">和局</div></td>
        <td><table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr align="right">
              ...
              <td width="51%"><a href="look_ds.php?match_id=<?=$rows["Match_ID"]?>&point_column=Match_Ho" <?=getAC($arr[$rows["Match_ID"]]["match_ho"]['num'])?> ><?=getString($arr[$rows["Match_ID"]]["match_ho"]['num'])?>/<?=getString($arr[$rows["Match_ID"]]["match_ho"]['money'])?></a></td>
            </tr>
            <tr align="right">
        ...
        <td><table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr align="right">
             ...
             <br /></td>
              <td width="67%"><a href="look_ds.php?match_id=<?=$rows["Match_ID"]?>&point_column=Match_BzM" <?=getAC($arr[$rows["Match_ID"]]["match_bzm"]['num'])?>><?=getString($arr[$rows["Match_ID"]]["match_bzm"]['num'])?>/<?=getString($arr[$rows["Match_ID"]]["match_bzm"]['money'])?></a></td>
            </tr>
            <tr align="right">
            ...
            <tr align="right">
              ...
              <td><a href="look_ds.php?match_id=<?=$rows["Match_ID"]?>&point_column=Match_BzH" <?=getAC($arr[$rows["Match_ID"]]["match_bzh"]['num'])?>><?=getString($arr[$rows["Match_ID"]]["match_bzh"]['num'])?>/<?=getString($arr[$rows["Match_ID"]]["match_bzh"]['money'])?></a> </td>
            </tr>
        </table></td>
    </tr>
<?php
