...
$gameId=is_numeric($_REQUEST['type']) ? intval($_REQUEST['type']) : 12;
			...
			<td valign="top">
				...
				<table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">
					<tr>
						...
						<td align="left" bgcolor="#FFFFFF"><?=$gameName?>【<a href="Auto_12.php?type=<?=$gameId?>" style="color:#ff0000;">点击进入开奖设置</a>】</td>
					</tr>
					<tr>
