...
//exit;
      	?>
	        <tr align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>;">
              <td><a href="list.php?match_name=<?=urlencode($rows["match_name"])?>"><?=$rows["match_name"]?></a><br/><span style="color:#999999;">www.hyl9888.com</span></td>
              <td>
              <?=$rows["number"]?><br/>
...
?></td>
	        ...
	        <tr>
	          <td colspan="8" align="left"><img src="http://www.hyl9888.com/other/<?=substr($rows["number"],0,8)?>/<?=$rows["number"]?>.jpg" /></td>
      </tr>	
    </table>
<br/>
<?php
