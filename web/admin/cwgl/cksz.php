...
function get_bankico($name){
	switch ($name){
	  case "支付宝": $ico='alipay.jpg';break;
	  case "微信支付": $ico='wxzf.jpg';break;
...
<table width="100%" border="1" bgcolor="#FFFFFF" bordercolor="#96B697" cellspacing="0" cellpadding="0" style="border-collapse: collapse; color: #225d9c;" id=editProduct   idth="100%" >
	        ...
	        <tr align="center">
              ...
              <select name="card_bankName" id="card_bankName">
                ...
                <option value="招商银行" <? if($temp['card_bankName']=='招商银行') echo 'selected';?>>招商银行</option>
                <option value="邮政储蓄" <? if($temp['card_bankName']=='邮政储蓄') echo 'selected';?>>邮政储蓄</option>
                <option value="中信银行" <? if($temp['card_bankName']=='中信银行') echo 'selected';?>>中信银行</option>
                <option value="建设银行" <? if($temp['card_bankName']=='建设银行') echo 'selected';?>>建设银行</option>
                <option value="中国银行" <? if($temp['card_bankName']=='中国银行') echo 'selected';?>>中国银行</option>
                <option value="平安银行" <? if($temp['card_bankName']=='平安银行') echo 'selected';?>>平安银行</option>
              </select></td>
          </tr>
    </tr>
	        <tr align="center">
