...
//for($pages=0;$pages<$t_page;$pages++){
	$data=theif_data($webdb["datesite"],$webdb["cookie"],'FT','hr',$langx,$pages);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="left">
    <input type=button name=button value="繁体" onClick="window.location.href='?';">
    <?=$show_pages?>页<?=$show_msg?>条足球上半场！
