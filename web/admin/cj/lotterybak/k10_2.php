...
$curl->set_referrer("http://old.1680210.com/lottery/10016.html");
...
$html_data = $curl->fetch_url("http://old.1680210.com/Open/CurrentOpen?code=10016&_=0.3727684081279637");
$a=array('(',')');
$b=array('[',']');
