...
$curl->set_referrer("http://old.1680210.com/lottery/1008.html");
...
$html_data = $curl->fetch_url("http://old.1680210.com/Open/CurrentOpen?code=1008&_=0.22965576034578294");
$a=array('(',')');
$b=array('[',']');
