...
$curl->set_referrer("http://old.1680210.com/lottery/10011.html");
...
$html_data = $curl->fetch_url("http://old.1680210.com/Open/CurrentOpen?code=10011&_=0.3424344145450467");
$a=array('(',')');
$b=array('[',']');
