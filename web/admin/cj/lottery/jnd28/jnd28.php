...
$html_data = $curl->fetch_url("http://www.pc558.com/jnd28/");
...
foreach($html_arr[1] as $key=>$val){
	...
	if(strlen($qihao)>0){	
		...
		if($tcou==0){
			$time   = $addtime;
			$sql 	= "insert into c_auto_13(qishu,datetime,ball_1,ball_2,ball_3,ball_4) values ('$qihao','$time','$hm28_1','$hm28_2','$hm28_3','$hm28_4')";
			//echo $sql;
			$mysqli->query($sql);
...
<table width="100%"border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="left">
      ...
      加拿大28<br>(<?=$dqihao?>期:<?="$dhm28_1+$dhm28_2+$dhm28_3=$dhm28_4"?>)<br>
      <span id="timeinfo"></span>
      </td>
  </tr>
</table>
<iframe src="./js/Js_jnd28.php?qi=<?=$qihao?>" frameborder="0" scrolling="no" height="0" width="0"></iframe>
</body>
</html>