...
//for($pages=0;$pages<$t_page;$pages++){
	$data=theif_data($webdb["datesite"],$webdb["cookie"],'FT','t',$langx,$pages);
...
if (parselimit==1) 
	...
	if (curmin!=0) 
		curtime=curmin+"秒获取最新数据！" 
	else 
		curtime=cursec+"秒获取最新数据！" 
