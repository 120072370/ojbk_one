...
if($_GET["action"]=="add" && $id==0){ 
	...
	$ball_6		=	$_POST["ball_6"];
	$ball_7		=	$_POST["ball_7"];
	$sql		=	"select qishu from c_auto_17 where qishu=".$qishu." limit 1";
	...
	$sql		=	"insert into c_auto_17(qishu,opentime,endtime,datetime,ball_1,ball_2,ball_3,ball_4,ball_5,ball_6,ball_7) values (".$qishu.",'".$opentime."','".$endtime."','".$datetime."',".$ball_1.",".$ball_2.",".$ball_3.",".$ball_4.",".$ball_5.",".$ball_6.",".$ball_7.")";
	$mysqli->query($sql);
	...
	$ball_6		=	$_POST["ball_6"];
	$ball_7		=	$_POST["ball_7"];
	$sql		=	"update c_auto_17 set qishu=".$qishu.",opentime='".$opentime."',endtime='".$endtime."',datetime='".$datetime."',ball_1=".$ball_1.",ball_2=".$ball_2.",ball_3=".$ball_3.",ball_4=".$ball_4.",ball_5=".$ball_5.",ball_6=".$ball_6.",ball_7=".$ball_7." where id=".$id."";
	$mysqli->query($sql);
...
if($id>0 && !isset($_GET['action'])){
	$sql	=	"select * from c_auto_17 where id=$id limit 1";
	$query	=	$mysqli->query($sql);
	$rs		=	$query->fetch_array();
}
...
<?php
$sql		=	"select id from c_auto_17 order by qishu desc";
$query		=	$mysqli->query($sql);
...
if($id){
	$id	=	rtrim($id,',');
	$sql	=	"select * from c_auto_17 where id in($id) order by qishu desc";
	$query	=	$mysqli->query($sql);
	$time	=	time();
