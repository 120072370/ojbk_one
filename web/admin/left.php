		...
		<div class="bg_01">
			<div class="bg_02">
				<div class="bg_03">
					<div class="system">
						<div class="img"></div>
						<div class="txt10"><span>星耀娱乐乐园</span></div>
					</div>
					<!--<?php
					...
					if(strpos($quanxian,'lhcgl')){
					?>
					<div class="bg_10" id="gslhcgl" onclick="s_h('gslhcgl','gslhcgl_1')">高速彩管理</div>
					<div class="bg_11" id="gslhcgl_1">
                        <table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="gsSix/Six_Auto.php" target="mainFrame">开奖号码管理</a></td>
							</tr>
                            <tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="gsSix/Six_Odds.php" target="mainFrame">即时赔率管理</a></td>
							</tr>
                            <tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="gsSix/Six_Order.php" target="mainFrame">彩票注单列表</a></td>
							</tr>
						</table>
					</div>
					<?php
