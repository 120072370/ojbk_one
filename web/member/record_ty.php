...
<div class="wrap">
    ...
    <div class="content">
            ...
            if(!$id) {
                ...
                while($rows = $query->fetch_array()){
                    ...
                    <tr class="list">
                        ...
                        <td align="center"><span class="c_blue f_b"><?= $rows["match_name"] ?></span>
                            <?
                            //正则匹配
                            $m_count = count($m);
                        ...
                        <td><?php
                            if ($rows["status"] == 0) {
                                ...
                                else echo '<span class="c_red">审核中</span>';
                            } else {
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="page">
            <tr>
                <td align="left">本页总投注金额：<span class="c_red"><?= $bet_money ?></span> RMB，最高可赢金额：<span class="c_red"><?= double_format($ky) ?></span> RMB</td>
