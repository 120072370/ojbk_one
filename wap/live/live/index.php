				...
				<!--AG捕鱼-->
					 ...
					 <div class="ag-content ag_fish">
							<div class="ag-fishbanner">
							  <a class="ag-link" href="http://gci.casino6668.com:81/forwardGame.do?params=QVW8NcBm3cmAmw/CIwf55BsSP5tPxBisguGZTAmfMvAidpdDVsJU9wlEmKnhqHA0zm6C9kuSapVdaN+CZSHmS3QQA4cwixVj3vVqoNcemtiz4kwhqaZBqtiytLA2nO0nAFgwAOW0e6aidqTbmpvpXVh5XnAwULxVKzkVkjIzpjJi/akgGS/mA7ssEctXQelBgo7jPezp3DGFSVnLWDZT50s2yDjGspYAa+wg/T63DPTKCm+0X9sT3g==&key=c23a9a3a46f7bbbbaf4b35567b620c9b" onclick="if(<?echo($_SESSION['username']==''?'true':'false')?>){alert('请先登录');return false;}" target="_blank" ></a>
							</div>
							<div class="ag-list">
							  <div class="f-title">BBIN视讯游戏帮助</div>
							</div>
							<div class="ag-list">
								<div class="ag-f-tab">
									<div id="ftb-con">
...
#index_loginbox .loginbox { box-shadow: 0 0  6px rgba(0,0,0,0.5);  margin-top:-445px;  position: fixed; top: 50%; left:50%; background: rgb(252,244,225);  border: 2px solid rgb(242, 218, 168); }
