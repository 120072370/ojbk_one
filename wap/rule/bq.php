...
<p class="b sub">1. 一般规则</p>
    <ul style="list-style:decimal;">
      ...
      <li>国际棒球比赛规则: 如果比赛最少进行七局后有一队领先10分，或进行五局后有一队领先15分，赛事将会提早结束。如果遇此情况，所有的投注将继续保持有效，包括独赢盘，单/双盘，让分盘（让垒盘）和大/小盘（总比分）。 </li>
    ...
    <p>以下列出棒球可提供的个别玩法规则。 </p>
    <ul style="margin-left: 25px;">
      <p class="b sub">2.1. 独赢盘</p>
      <ul style="list-style:decimal;">
        <li>预测哪一支球队将在比赛胜出。 </li>
        <li>出于结算的用意，加时赛将计算在内。 </li>
      </ul>
      <p class="b sub">2.2. 让分盘</p>
      <ul style="list-style:decimal;">
        <li>预测那一支球队在盘口指定的让分数赢得某个时节或全场比赛。 </li>
        <li>出于结算的用意，加时赛将计算在内。 </li>
      </ul>
      <p class="b sub">2.3. 滚球让分盘</p>
      <ul style="list-style:decimal;">
        <li>预测那一支球队在盘口指定的让分数赢得某个时节或全场比赛。 </li>
        <li>结算是以投注时到比赛/时节结束后的赛果做裁决。 </li>
        <li>出于结算的用意，加时赛将计算在内。 </li>
      </ul>
      <p class="b sub">2.4. 大/小盘(总比分)</p>
      <ul style="list-style:decimal;">
      ...
      <p class="b sub">2.5. 滚球大/小盘(总比分)</p>
      <ul style="list-style:decimal;">
        <li>预测赛事总比分将大于或小于在盘口指定的大/小盘分数。 </li>
        <li>结算是以0-0的比分按盘口开出的大小盘让分数做裁决。投注当时的比分对结算没有影响。 </li>
        <li>出于结算的用意，加时赛将计算在内。 </li>
      </ul>
      <p class="b sub">2.6. 单/双</p>
      <ul style="list-style:decimal;">
