...
function theif_data($site,$uid,$gtype,$rtype,$langx,$page_no){
	...
	case 'FS':
		...
		$filename = "$site/app/member/browse_FS/reloadgame_R.php?mid=1&uid=$uid&langx=$langx&choice=ALL&LegGame=ALL&pages=1&records=40&FStype=&area_id=&league_id=&rtype=$rtype";
		//echo $filename;exit;
		break;
	case 'OU':
	...
	case 'NOT':
		...
		$filename="$site/app/member/scroll_history.php?uid=$uid&langx=$langx";
		break;
	default:
		$gtype_browse=$gtype."_browse";
